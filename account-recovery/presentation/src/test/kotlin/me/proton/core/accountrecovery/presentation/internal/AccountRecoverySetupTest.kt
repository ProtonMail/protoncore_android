...
class AccountRecoverySetupTest : CoroutinesTest by CoroutinesTest() {
    @MockK
    ...
    private lateinit var tested: AccountRecoverySetup

    @BeforeTest
    fun setUp() {
        MockKAnnotations.init(this)

        tested = AccountRecoverySetup(
            accountManager,
            activityProvider,
    ...
    @Test
    fun accountRecoveryDisabled() = coroutinesTest {
        every { isAccountRecoveryEnabled() } returns false
        tested()
        verify { isAccountRecoveryEnabled() }
    }
