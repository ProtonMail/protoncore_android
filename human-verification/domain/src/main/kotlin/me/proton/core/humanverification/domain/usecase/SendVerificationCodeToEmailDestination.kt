...
class SendVerificationCodeToEmailDestination @Inject constructor(
     ...
     */
    suspend operator fun invoke(sessionId: SessionId? = null, emailAddress: String) {
        require(emailAddress.isNotEmpty()) { "Provide valid email destination." }
        return userVerificationRepository.sendVerificationCodeEmailAddress(
            sessionId = sessionId,
