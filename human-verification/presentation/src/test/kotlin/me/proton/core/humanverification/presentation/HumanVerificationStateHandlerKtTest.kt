...
class HumanVerificationStateHandlerKtTest {
    @Test
    fun `convert hv details to input`() {
        val clientId = ClientId.AccountSession(SessionId("session_id"))
        assertEquals(
    ...
    @Test
    fun `missing verification token`() {
        val clientId = ClientId.AccountSession(SessionId("session_id"))
