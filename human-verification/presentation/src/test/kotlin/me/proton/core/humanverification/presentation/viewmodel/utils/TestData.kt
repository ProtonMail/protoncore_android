...
package me.proton.core.humanverification.presentation.viewmodel.utils
...
val countryTop1 = Country("51", "top first", 51)
val countryTop2 = Country("52", "top second", 52)
val countryTop3 = Country("53", "top third", 53)
val countryTop4 = Country("54", "top fourth", 54)
val countryTop5 = Country("55", "top fifth", 55)
...
val testCountriesMostUsed = listOf(countryTop1, countryTop2, countryTop3, countryTop4, countryTop5)
