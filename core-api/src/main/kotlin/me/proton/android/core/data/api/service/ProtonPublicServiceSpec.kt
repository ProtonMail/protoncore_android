...
/**
 * Created by dinokadrikj on 4/28/20.
 * Specifications for Public API
 */
interface ProtonPublicServiceSpec {

    suspend fun refreshSync(refreshBody: RefreshBody): RefreshResponse
}