...
@Serializable
@Schema(description = "Request Admin Help for SSO user.")
@SchemaId("https://proton.me/android_core_auth_sso_requestAdminHelp_total_v1.schema.json")
public data class LoginSsoRequestAdminHelpTotal(
