...
@Serializable
@Schema(description = "Reject SSO auth device.")
@SchemaId("https://proton.me/android_core_auth_sso_rejectDevice_total_v1.schema.json")
public data class LoginSsoRejectDeviceTotal(
