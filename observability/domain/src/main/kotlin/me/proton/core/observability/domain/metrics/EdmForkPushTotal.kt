...
@Serializable
@Schema(description = "Pushing a session fork for Easy Device Migration.")
@SchemaId("https://proton.me/android_core_edm_fork_push_total_v1.schema.json")
public class EdmForkPushTotal(
