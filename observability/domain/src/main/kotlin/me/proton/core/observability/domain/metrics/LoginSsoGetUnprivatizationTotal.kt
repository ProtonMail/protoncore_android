...
@Serializable
@Schema(description = "Get unprivatization info for SSO user.")
@SchemaId("https://proton.me/android_core_auth_sso_getUnprivatization_total_v1.schema.json")
public data class LoginSsoGetUnprivatizationTotal(
