...
@Serializable
@Schema(description = "Activate SSO auth device.")
@SchemaId("https://proton.me/android_core_auth_sso_activateDevice_total_v1.schema.json")
public data class LoginSsoActivateDeviceTotal(
