...
public object LocalProductMetricsDelegateOwner {
    private val LocalProductMetricsDelegateOwner =
        compositionLocalOf<ProductMetricsDelegateOwner?> { null }

    public val current: ProductMetricsDelegateOwner?
        @Composable
