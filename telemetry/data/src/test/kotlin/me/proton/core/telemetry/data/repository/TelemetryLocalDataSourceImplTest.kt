...
class TelemetryLocalDataSourceImplTest {
    ...
    fun beforeEveryTest() {
        ...
        source = TelemetryLocalDataSourceImpl(db)
    }
    ...
    fun `delete event works properly`() = runTest {
        ...
        // WHEN
        source.deleteEvents(userId, listOf(event))
        // THEN
    ...
    fun `delete multiple events works properly`() = runTest {
        ...
        // WHEN
        source.deleteEvents(userId, listOf(event1, event2))
        // THEN
    ...
    fun `get events with limit works properly`() = runTest {
        ...
        // WHEN
        val result = source.getEvents(userId, limit)
        // THEN
