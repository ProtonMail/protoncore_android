...
fun UserSettingsProperty.toUserSettingsPropertySerializable() = when (this) {
    is CrashReports -> UserSettingsPropertySerializable.CrashReports(value)
    is Telemetry -> UserSettingsPropertySerializable.Telemetry(value)
}
