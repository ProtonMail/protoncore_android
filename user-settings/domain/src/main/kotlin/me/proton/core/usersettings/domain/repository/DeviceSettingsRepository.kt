...
interface DeviceSettingsRepository {
    ...
    /**
     * Observe [DeviceSettings].
     */
    fun observeDeviceSettings(): Flow<DeviceSettings>
    ...
    /**
     * Updates [DeviceSettings.isTelemetryEnabled].
     */
    suspend fun updateIsTelemetryEnabled(isEnabled: Boolean)

    /**
     * Updates [DeviceSettings.isCrashReportEnabled].
     */
