...
class PerformUpdateTelemetryTest {
    // region mocks
    ...
    private lateinit var useCase: PerformUpdateTelemetry

    @Before
    fun beforeEveryTest() {
        useCase = PerformUpdateTelemetry(
            repository = repository
        )
    }

    @Test
    fun `update telemetry returns success`() = runTest {
        // GIVEN
        coEvery {
