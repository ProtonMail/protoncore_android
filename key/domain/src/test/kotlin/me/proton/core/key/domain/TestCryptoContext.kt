...
open class TestCryptoContext : CryptoContext {
    ...
    open inner class TestPGPCrypto : PGPCrypto {
        ...
        override fun getBase64EncodedNoWrap(array: ByteArray): String = array.toString()
        ...
        override fun generateNewToken(size: Int): ByteArray = "token".toByteArray()
        override fun generateRandomBytes(size: Int): ByteArray = "random".toByteArray()
