...
public class Quark constructor(
    ...
    public enum class InternalApiEndpoint {
        ...
        EXPIRE_SESSION,
        SESSION_EXPIRE_REFRESH_TOKEN,
        USER_REACTIVATE,
        USER_EXPIRE_SESSION,
        ACCOUNT_QUOTA_SET_USED_SPACE,
        NEW_PAYMENTS_COUPON_IMPORT,
        NEW_PAYMENTS_ADD_PROMOTION_CREDITS,
        NEW_PAYMENTS_RECORD_OFFLINE_PAYMENT,
        NEW_PAYMENTS_ADD_ENTITLEMENT,
        NEW_PAYMENTS_SEND_SUBSCRIPTION_NOTIFICATION,
        NEW_PAYMENTS_SEED_SUBSCRIBER,
