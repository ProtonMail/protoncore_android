...
class ExistingPaymentMethodsRobot : PaymentRobot() {
    ...
    inline fun addNewCard(): NewCreditCardRobot = clickElement(R.id.addCreditCardButton)
    inline fun selectPaymentMethod(details: String): ExistingPaymentMethodsRobot {
