...
class CreatePaymentTokenWithNewPayPalTest {
    private lateinit var tested: CreatePaymentTokenWithNewPayPal
    ...
    fun setUp() {
        ...
        tested = CreatePaymentTokenWithNewPayPal(mockk(relaxed = true), observabilityManager)
    }
