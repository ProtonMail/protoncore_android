 ...
 * For payment tokens with new payment methods @see [CreatePaymentToken].
 */
class CreatePaymentTokenWithExistingPaymentMethod @Inject constructor(
    ...
    suspend operator fun invoke(
        ...
        require(amount >= 0)
        return paymentsRepository.createPaymentToken(sessionId, amount, currency, null, paymentMethodId)
    }
}
