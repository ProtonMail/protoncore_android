...
class StartPaymentTokenApproval : ActivityResultContract<PaymentTokenApprovalInput, PaymentTokenApprovalResult?>() {
...
class StartBilling : ActivityResultContract<BillingInput, BillingResult?>() {
