...
object ResponseCodes {
    ...
    const val AUTH_DEVICE_NOT_FOUND = 10_300
    const val AUTH_DEVICE_NOT_ACTIVE = 10_301
    const val UNPRIVATIZATION_NOT_ALLOWED = 10401
    const val AUTH_DEVICE_TOKEN_INVALID = 10_302
    const val AUTH_DEVICE_REJECTED = 10_303
