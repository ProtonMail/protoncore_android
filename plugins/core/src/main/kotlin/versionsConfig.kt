...
internal fun initVersions(libs: VersionCatalog) {
    ...
    // region Android
    `activity version` =                        "1.10.1"
    `android-annotation version` =              "1.7.1"
    ...
    `retrofit-kotlin-serialization version` =   "1.0.0"
...
public const val `composeRuntime version`: String =            "1.7.5"
public const val `composeFoundation version`: String =         "1.7.5"
public const val `composeAnimation version`: String =          "1.7.5"
public const val `composeUi version`: String =                 "1.7.5"
public const val `composeMaterial version`: String =           "1.7.5"
public const val `coordinatorlayout version`: String =         "1.2.0"
public const val `googlePlayFido version`: String =            "21.2.0"
public const val `googlePlayBilling version`: String =         "7.1.1"
public const val `datastore version`: String =                 "1.1.7"
public const val `drawerLayout version`: String =              "1.1.1"
public const val `hilt-navigation-compose version`: String =   "1.2.0"
public const val `material3 version`: String =                 "1.3.1"
...
// region Crypto
public const val `android-golib version`: String =                "2.9.0-2"
// endregion
...
public const val `leakCanary version`: String =            "2.14"
public const val `miniDns version`: String =               "1.0.4"
public const val `okHttp version`: String =                "4.12.0"
public const val `certificate-transparency version`: String = "2.7.1"
...
public const val `sentry version`: String =                "7.21.0"
...
public const val `uiautomator version`: String =                "2.3.0"
