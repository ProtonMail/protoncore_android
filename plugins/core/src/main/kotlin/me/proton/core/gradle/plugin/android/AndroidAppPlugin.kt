...
import me.proton.core.gradle.plugin.AndroidAppExtension
import me.proton.core.gradle.plugin.PluginIds
import me.proton.core.gradle.plugin.createProtonExt
import org.gradle.api.Project

public class AndroidAppPlugin : BaseAndroidPlugin<AndroidAppExtension>() {
    override val androidPluginId: String get() = PluginIds.androidApp
    ...
    override fun createPluginExtension(target: Project): AndroidAppExtension = target.createProtonExt()
}
