...
import ch.protonmail.libs.core.ui.adapter.BaseAdapter.DiffCallback
import ch.protonmail.libs.core.ui.adapter.BaseAdapter.ItemsComparator
...
abstract class BaseAdapter<UiModel, ViewHolder : ClickableAdapter.ViewHolder<UiModel>>(
    ...
    /** A lambda that will be triggered when an item is long clicked */
