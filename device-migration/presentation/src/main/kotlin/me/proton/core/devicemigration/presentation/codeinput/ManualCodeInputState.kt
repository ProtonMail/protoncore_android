...
public sealed interface ManualCodeInputState {
    public data object Idle : ManualCodeInputState
    public data object Loading : ManualCodeInputState
...
internal fun ManualCodeInputState.isLoading(): Boolean = this is ManualCodeInputState.Loading
