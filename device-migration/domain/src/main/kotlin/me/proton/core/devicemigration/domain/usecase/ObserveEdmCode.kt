...
public class ObserveEdmCode(
    ...
    /**
     * @param autoRefreshDuration Duration after which the code will be automatically refreshed.
     *  Note: Code generated by GenerateEdmCode expires after 10 minutes.
     * @param withEncryptionKey See [GenerateEdmCode.invoke]
     */
    @OptIn(FlowPreview::class)
    public operator fun invoke(
        sessionId: SessionId?,
        autoRefreshDuration: Duration = 9.minutes,
        withEncryptionKey: Boolean = true
    ): Flow<EdmCodeResult> = flow {
        emit(generateEdmCode(sessionId = sessionId, withEncryptionKey = withEncryptionKey))
        awaitCancellation()
