...
public class ConvertToObservabilityGiapStatusImpl @Inject constructor() : ConvertToObservabilityGiapStatus {
    override fun invoke(result: Result<*>): GiapStatus = result.toGiapStatus()
}
