...
public class ContentResolverEnvironmentConfigModule {
    @Provides
    @Singleton
    public fun provideContentResolverEnvironmentConfig(@ApplicationContext context: Context): EnvironmentConfiguration {
        val configFieldProvider = ContentResolverConfigProvider(context)
        return EnvironmentConfiguration(configFieldProvider)
    }
}
