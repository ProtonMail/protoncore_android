...
class GetEncryptedPassphrasePayload @Inject constructor(
     ...
     * wrapped in [SessionForkPayload], serialized to JSON string,
    ...
    suspend operator fun invoke(
        ...
        requireNotNull(passphraseRepository.getPassphrase(userId))
            ...
            .use { decryptedPassphrase ->
                val serializedPayload = SessionForkPayload(keyPassword = String(decryptedPassphrase.array)).serialize()
