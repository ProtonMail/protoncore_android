...
class IsLoginTwoStepEnabledImpl @Inject constructor(
    ...
    private fun isLocalEnabled(): Boolean {
        return context.resources.getBoolean(R.bool.core_feature_auth_signin_two_step_enabled)
    }
    ...
    internal companion object {
        val featureId = FeatureId("MobileLoginTwoStepDisabled")
    }
}
