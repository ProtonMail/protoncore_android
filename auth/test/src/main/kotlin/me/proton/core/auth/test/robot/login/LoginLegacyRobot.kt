...
public object LoginLegacyRobot {
    ...
    public fun fillUsername(username: String): LoginLegacyRobot = apply {
        usernameInput.typeText(username)
    }

    public fun fillPassword(password: String): LoginLegacyRobot = apply {
