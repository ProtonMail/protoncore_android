...
/**
 * Minimal abstract Payments tests for new user registration using external email (External).
 ...
 * open class ExternalRegistrationWithSubscriptionFlowTest(plan: Plan) :
 *     MinimalExternalRegistrationWithSubscriptionTest(plan) {
 *
