...
@HiltWorker
internal class FetchLabelWorker @AssistedInject constructor(
    @Assisted context: Context,
    @Assisted params: WorkerParameters,
    private val fetchLabelRemote: FetchLabelRemote,
    ...
    companion object {
        ...
        private fun makeInputData(userId: UserId, type: LabelType): Data {
            return workDataOf(
        ...
        fun getRequest(userId: UserId, type: LabelType): OneTimeWorkRequest {
            val inputData = makeInputData(userId, type)
            val constraints = Constraints.Builder()
                .setRequiredNetworkType(NetworkType.CONNECTED)
                .build()
            return OneTimeWorkRequestBuilder<FetchLabelWorker>()
                .addTag(userId.id)
