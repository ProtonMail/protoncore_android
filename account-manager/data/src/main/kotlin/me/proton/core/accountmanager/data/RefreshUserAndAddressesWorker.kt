...
class RefreshUserAndAddressesWorkManager @Inject constructor(
    private val workManager: WorkManager
) {
    fun enqueue(userId: UserId) {
        val request = OneTimeWorkRequestBuilder<RefreshUserAddressesWorker>()
            .setConstraints(
                Constraints.Builder()
...
@HiltWorker
internal class RefreshUserAddressesWorker @AssistedInject constructor(
