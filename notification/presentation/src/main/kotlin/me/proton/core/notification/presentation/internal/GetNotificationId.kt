...
internal class GetNotificationId @Inject constructor() {
    operator fun invoke(notification: Notification): Int = invoke(notification.notificationId)
    operator fun invoke(notificationId: NotificationId): Int = notificationId.hashCode()
}
