...
public class IsNotificationsPermissionRequestEnabledImpl @Inject constructor(
    @ApplicationContext private val context: Context
) : IsNotificationsPermissionRequestEnabled {
    override fun invoke(): Boolean =
        context.resources.getBoolean(R.bool.core_feature_notifications_permission_request_enabled)
}
