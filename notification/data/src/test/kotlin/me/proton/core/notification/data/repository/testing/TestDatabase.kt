...
@Database(
    entities = [
        AccountMetadataEntity::class, AccountEntity::class, NotificationEntity::class,
...
internal abstract class TestDatabase : BaseDatabase(), AccountDatabase, NotificationDatabase, UserDatabase
